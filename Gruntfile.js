module.exports = function(grunt) {
    grunt.initConfig({
        less: {
            dev: {
                ...
                files: {
                    "web/css/style.css": "frontend/css/source/main.less"
                }
            },
            prod: {
                options: {
    ...
    grunt.registerTask('default', ['less:dev', 'postcss:dev', 'image', 'watch']);
    grunt.registerTask('prod', ['less:prod', 'postcss:prod', 'image']);
