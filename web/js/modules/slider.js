...
class Slider
{
    ...
    initEvents() {
        ...
        /** if mouse under slider stop autoplay */
        this.params.el.addEventListener('mouseover', () => {
            if(this.params.autoplay) {
                clearTimeout(this.timerId);
            }
        });

        /** if mouse out slider activate autoplay */
        this.params.el.addEventListener('mouseout', () => {
            if(this.params.autoplay) {
                this.initAutoplay();
            }
        });
